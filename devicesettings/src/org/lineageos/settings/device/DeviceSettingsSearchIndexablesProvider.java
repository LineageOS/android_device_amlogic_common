...
import org.lineageos.settings.device.ColorSpaceSettingsActivity;

public class DeviceSettingsSearchIndexablesProvider extends SearchIndexablesProvider {
    private static final String TAG = DeviceSettingsSearchIndexablesProvider.class.getSimpleName();

    private static final int SEARCH_IDX_COLORSPACE_SETTINGS = 0;

    private static SearchIndexableResource[] INDEXABLE_RES = new SearchIndexableResource[]{
            new SearchIndexableResource(1, R.xml.colorspace_settings,
                    ColorSpaceSettingsActivity.class.getName(),
    ...
    public Cursor queryXmlResources(String[] projection) {
        ...
        cursor.addRow(generateResourceRef(INDEXABLE_RES[SEARCH_IDX_COLORSPACE_SETTINGS]));
        return cursor;
    }
