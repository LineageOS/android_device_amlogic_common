...
# --- 1. Set global platform defaults first ---
TARGET_BOOTLOADER_IS_2ND := false
BOARD_KERNEL_BASE        := 0x0

# --- 2. Evaluate specific kernel configurations ---
ifeq ($(TARGET_KERNEL_VERSION),5.15)
...
BOARD_MKBOOTIMG_ARGS       := --kernel_offset $(BOARD_KERNEL_OFFSET) --second_offset $(BOARD_SECOND_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --dtb_offset $(BOARD_DTB_OFFSET)
endif
